...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_3.setTitle(_translate("MainWindow", "MUEnode"))
        self.cboMasternodes.setToolTip(_translate("MainWindow", "List of configured MUEnodes"))
        self.btnNewMn.setToolTip(_translate("MainWindow", "Create a new MUEnode configuration"))
        self.btnNewMn.setText(_translate("MainWindow", "New"))
        self.btnDuplicateMn.setToolTip(_translate("MainWindow", "Duplicate MUEnode entry"))
        self.btnDuplicateMn.setText(_translate("MainWindow", "Duplicate"))
        self.btnDeleteMn.setToolTip(_translate("MainWindow", "Delete current MUEnode configuration"))
        ...
        self.edtMnIp.setToolTip(_translate("MainWindow", "The MUEnode\'s IP address for incoming communication with other nodes"))
        self.label_11.setText(_translate("MainWindow", "port:"))
        self.edtMnPort.setToolTip(_translate("MainWindow", "The MUEnode\'s TCP port number for incoming communication with other nodes"))
        self.chbUseDefaultProtocolVersion.setToolTip(_translate("MainWindow", "Use the protocol version number (from the RPC node) when starting MUEnode"))
        self.chbUseDefaultProtocolVersion.setText(_translate("MainWindow", "Use default protocol version"))
        self.edtMnProtocolVersion.setToolTip(_translate("MainWindow", "Enter the protocol version number to be sent at MUEnode start time"))
        ...
        self.edtMnCollateralTx.setToolTip(_translate("MainWindow", "The collateral transaction hash from the 500000 MUE deposit"))
        self.label_7.setText(_translate("MainWindow", "TX index:"))
        self.edtMnCollateralTxIndex.setToolTip(_translate("MainWindow", "The collateral transaction\'s (unspent) output index with the 500000 MUE deposit (usally 0)"))
        self.edtMnCollateralAddress.setToolTip(_translate("MainWindow", "MUE address of the 500000 MUE collateral, coverted from BIP32 path with hardware wallet."))
        self.edtMnCollateralAddress.setPlaceholderText(_translate("MainWindow", "MUE address"))
        self.btnHwAddressToBip32.setToolTip(_translate("MainWindow", "Convert MUE address to BIP32 path using hardware wallet"))
        self.btnHwBip32ToAddress.setToolTip(_translate("MainWindow", "Convert BIP32 path to MUE address using hardware wallet"))
        self.edtMnCollateralBip32Path.setToolTip(_translate("MainWindow", "BIP32 path of the 500000 MUE collateral (e.g. 44\'/5\'/0\'/0/0)"))
        ...
        self.label_9.setText(_translate("MainWindow", "MUEnode private key:"))
        self.label_8.setText(_translate("MainWindow", "MUEnode status:"))
        self.label_12.setText(_translate("MainWindow", "Name:"))
        self.edtMnName.setToolTip(_translate("MainWindow", "The MUEnode\'s configuration name"))
        ...
        self.label_5.setText(_translate("MainWindow", "MUEnodes:"))
        self.label_10.setText(_translate("MainWindow", "IP:"))
        self.edtMnPrivateKey.setToolTip(_translate("MainWindow", "MUEnode\'s private key. Use your own or click the button <Generate new> to create a new and random private key with the use of \'bitcoin\' library."))
        self.btnRefreshMnStatus.setToolTip(_translate("MainWindow", "Get MUEnode\'s status"))
        self.btnRefreshMnStatus.setText(_translate("MainWindow", "Get status"))
        self.btnBroadcastMn.setToolTip(_translate("MainWindow", "Broadcast information about the MUEnode"))
        self.btnBroadcastMn.setText(_translate("MainWindow", "Start MUEnode using hardware wallet"))
        ...
        self.action_transfer_funds_for_cur_mn.setText(_translate("MainWindow", "Transfer Funds for Current MUEnode..."))
        self.action_transfer_funds_for_all_mns.setText(_translate("MainWindow", "Transfer Funds for All MUEnodes"))
        self.action_transfer_funds_for_any_address.setText(_translate("MainWindow", "Transfer Funds for Any Address"))
        self.action_sign_message_for_cur_mn.setText(_translate("MainWindow", "Sign Message for Current MUEnode..."))
        ...
        self.action_check_network_connection.setToolTip(_translate("MainWindow", "Check MUE Network Connection"))
        ...
        self.action_about_app.setText(_translate("MainWindow", "About MUEnode Tool..."))
        self.action_import_masternode_conf.setText(_translate("MainWindow", "Import MUEnodes from the muenode.conf file..."))
        ...
        self.action_gen_mn_priv_key_compressed.setText(_translate("MainWindow", "Generate MUEnode private key (compressed)"))
        self.action_gen_mn_priv_key_compressed.setShortcut(_translate("MainWindow", "Ctrl+Alt+C"))
        self.action_gen_mn_priv_key_uncompressed.setText(_translate("MainWindow", "Generate MUEnode private key (uncompressed)"))
        self.action_gen_mn_priv_key_uncompressed.setToolTip(_translate("MainWindow", "Generate MUEnode private key (uncompressed)"))
